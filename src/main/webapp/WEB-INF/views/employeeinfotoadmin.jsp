				...
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="/admin">Home</a> <span class="mx-2 mb-0">/</span> <a
							href="/admin/employeedetails">Employee Details</a> <span class="mx-2 mb-0">/</span> <strong
							class="text-black">${employee.name}</strong>
					</div>
				</div>
			</div>
		</div>
						...
						<div class="mt-5">
							<ul class="nav nav-pills mb-3 custom-pill" id="pills-tab"
								...
								<li class="nav-item"><a class="nav-link"
									...
									role="tab" aria-controls="pills-profile" aria-selected="false">Employee Details</a>
								</li>
							...
							<div class="tab-content" id="pills-tabContent">
								<div class="tab-pane fade show active" id="pills-profile" role="tabpanel"
									...
									<table class="table custom-table">
										...
										<tbody>
											...
											<tr>
												<td>Salary</td>
												<td class="bg-light">${employee.salary } <a href = "/admin/editemployeesalaryandshopid/${employee.uname }">  ( Edit Salary)</a></td>
											</tr>
											<tr>
												<td>Shop ID</td>
												<td class="bg-light">${employee.shopid }  <a href = "/admin/editemployeesalaryandshopid/${employee.uname }">  ( Edit Shopid)</a></td>
											</tr>
											<tr>
												<td>Address</td>
								...
								<p>
									<form action = "/admin/deleteemployee/${employee.uname }" method = "POST">
									<input type = "submit" class="buy-now btn btn-sm height-auto px-4 py-3 btn-primary" value = "Delete Employee">
									</form>
