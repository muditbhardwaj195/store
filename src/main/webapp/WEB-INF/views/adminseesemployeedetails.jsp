				...
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="/admin">Home</a> <span class="mx-2 mb-0">/</span> <strong
							class="text-black">Employees Details</strong>
					</div>
				</div>
			</div>
		</div>
						...
						<div class="site-blocks-table">
							<table class="table table-bordered">
								<thead>
									<tr>
										<th>Employee ID</th>
										<th class="product-name">Employee Username</th>
										<th class="product-price">Employee Name</th>
								...
								<tbody>
									<c:forEach items="${employees }" var="employee">
										<tr>
											...
											<td><a href = "/admin/viewemployeeinfo/${employee.uname }">${employee.uname }</a></td>
											<td>${employee.name }</td>
