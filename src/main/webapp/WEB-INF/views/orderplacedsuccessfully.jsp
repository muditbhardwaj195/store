				...
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="/customer">Home</a> <span class="mx-2 mb-0">/</span> <strong
							class="text-black">Order Placed Successfully!</strong>
					</div>
				</div>
			</div>
		</div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p class="lead mb-5">Your orderid is ${orderid }.<a href = "/customer/orderdetails/${orderid}">Click here to view details</a></p>
            <p><a href="/customer" class="btn btn-md height-auto px-4 py-3 btn-primary">Back to store</a></p>
          </div>
        </div>
      </div>
    </div>
