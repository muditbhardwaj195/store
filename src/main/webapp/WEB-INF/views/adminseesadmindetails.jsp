				...
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="/admin">Home</a> <span class="mx-2 mb-0">/</span> <strong
							class="text-black">Admin Details</strong>
					</div>
				</div>
			</div>
		</div>
						...
						<div class="site-blocks-table">
							<table class="table table-bordered">
								<thead>
									<tr>
										<th>Admin ID</th>
										<th class="product-name">Admin Username</th>
										<th class="product-price">Admin Name</th>
								...
								<tbody>
									<c:forEach items="${admins }" var="admins">
										<tr>
											...
											<td><a href = "/admin/viewadmininfo/${admins.uname }">${admins.uname }</a></td>
											<td>${admins.name }</td>
											<td>${admins.phone }</td>
											<td>${admins.email }</td>
										</tr>
