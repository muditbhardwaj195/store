			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-12">
						...
						<form action="/admin/editprofiledetails" method="post">
							...
							<div class="p-3 p-lg-5 border">
								<div class="form-group row">
									<div class="col-md-6">
										...
										<input type="text"
											class="form-control" id="name" name="name" value = ${admin.name }>
									</div>
									<div class="col-md-6">
										<label for="phone" class="text-black">Phone No. <span
											class="text-danger">*</span></label> <input type="text"
											class="form-control" id="phone" name="phone" value = ${admin.phone }>
									</div>
								</div>
								<div class="form-group row">
									<div class="col-md-6">
										<label for="gender" class="text-black">Gender <span
											class="text-danger">*</span></label> 
										<input type="text"
											class="form-control" id="gender" name="gender" value = ${admin.gender }>
									</div>
									<div class="col-md-6">
										<label for="doornum" class="text-black">Door No. <span
											class="text-danger">*</span></label> <input type="text"
											class="form-control" id="doornum" name="doornum" value = ${admin.doornum }>
									</div>
								</div>
								<div class="form-group row">
									<div class="col-md-6">
										<label for="streetname" class="text-black">Streetname <span
											class="text-danger">*</span></label> 
										<input type="text"
											class="form-control" id="streetname" name="streetname" value = ${admin.streetname }>
									</div>
									<div class="col-md-6">
										<label for="city" class="text-black">City <span
											class="text-danger">*</span></label> <input type="text"
											class="form-control" id="city" name="city" value = ${admin.city }>
									</div>
								</div>
								<div class="form-group row">
									<div class="col-md-6">
										<label for="state" class="text-black">State <span
											class="text-danger">*</span></label> 
										<input type="text"
											class="form-control" id="state" name="state" value = ${admin.state }>
									</div>
									<div class="col-md-6">
										<label for="pincode" class="text-black">Pincode <span
											class="text-danger">*</span></label> <input type="text"
											class="form-control" id="pincode" name="pincode" value = ${admin.pincode }>
									</div>
								</div>
								<div class="form-group row">
									<div class="col-lg-12">
										<label for="Date of Birth" class="text-black">Date of Birth<span
											class="text-danger">*</span></label>
										<input type="date" id="dob" name="dob" value = ${admin.dob }>
									</div>
								</div>
								<div class="form-group row">
									<div class="col-lg-12">
