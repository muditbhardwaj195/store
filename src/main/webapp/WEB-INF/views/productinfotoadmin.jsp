...
<body>
	...
	<div class="site-wrap">
				...
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="/admin">Home</a> <span class="mx-2 mb-0">/</span> <a
							href="/admin/productdetails">Product Details</a> <span class="mx-2 mb-0">/</span> <strong
		...
		<div class="site-section">
			<div class="container">
				<form action = "/admin/editproductmrpandquantity/${product.id}" method = "POST">
				<div class="row">
					<div class="col-md-12">
								...
								<div class="tab-pane fade show active" id="pills-profile" role="tabpanel"
									...
									<table class="table custom-table">
										...
										<tbody>
											...
											<tr>
												<td>Description</td>
												<td class="bg-light">${product.description }</td>
											</tr>
											<tr>
												<td>Brand</td>
											...
											<tr>
												...
												<td class="bg-light">
													...
													<input type = "submit" value = "Change M.R.P">
												</td>
											</tr>
											<tr>
												<td>Available Quantity</td>
												<td class="bg-light">${product.qtyinstock }</td>
											</tr>
											<tr>
												<td>Add Quantity</td>
												<td class="bg-light">
													<input type = "number" name = "addquantity" value = 0>
													<input type = "submit" value = "Add Quantity inStock">
												</td>
											</tr>
										</tbody>
									</table>
