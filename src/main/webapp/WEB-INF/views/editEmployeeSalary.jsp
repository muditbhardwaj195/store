...
<body>
	...
	<div class="site-wrap">
		...
		<div class="site-section">
			<div class="container">
				<form action = "/admin/editemployeesalaryandshopid/${employee.uname }" method = "POST">
				<div class="row">
					<div class="col-md-12">
									...
									<table class="table custom-table">
										...
										<tbody>
											...
											<tr>
												<td>Shop ID</td>
												<td class="bg-light">
													<input type = "number" name = "shopid" value = ${employee.shopid }>
													<input type = "submit" value = "Change ShopId">
												</td>
											</tr>
											<tr>
												<td>Address</td>
