...
<body>
	...
	<div class="site-wrap">
				...
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="/admin">Home</a> <span class="mx-2 mb-0">/</span> <strong
							class="text-black">Add Product</strong>
					</div>
				</div>
			</div>
		</div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="h3 mb-5 text-black text-center">Enter the details of new Product:</h2>
            <br>
		<p style="text-align:center; color:${colorOfInstruction} !important;">${msg}</p>
          </div>
          <div class="col-md-12">
    
            <form action="/admin/addnewproduct" method="POST">
              ...
              <div class="p-3 p-lg-5 border">
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="c_lname" class="text-black">Product Description <span class="text-danger">*</span></label>
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="c_subject" class="text-black">Brand Name </label>
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="c_subject" class="text-black">Image Link </label>
                    <input type="text" class="form-control" id="imname" name="imname" >
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-md-6">
                    <label for="c_fname" class="text-black">M.R.P. of Product <span class="text-danger">*</span></label>
                    <input type="number" class="form-control" id="mrp" name="mrp" required="required" >
                  </div>
                  <div class="col-md-6">
                    <label for="c_lname" class="text-black">Quantity of Stock <span class="text-danger">*</span></label>
                    <input type="number" class="form-control" id="qtyinstock" name="qtyinstock" required="required"/>
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-lg-12">
