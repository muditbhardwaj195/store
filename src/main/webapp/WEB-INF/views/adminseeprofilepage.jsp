					...
					<div class="col-md-6">
						...
						<div class="mt-5">
							...
							<div class="tab-content" id="pills-tabContent">
								<div class="tab-pane fade show active" id="pills-profile" role="tabpanel"
									...
									<table class="table custom-table">
										...
										<tbody>
											...
											<tr>
												<td>Phone</td>
												<td class="bg-light">${admin.phone }</td>
											</tr>
											<tr>
												<td>Email</td>
												<td class="bg-light">${admin.email }</td>
											</tr>
											<tr>
												<td>Username</td>
												<td class="bg-light">${admin.uname }</td>
											</tr>
											<tr>
												<td>Gender</td>
												<td class="bg-light">${admin.gender }</td>
											</tr>
											<tr>
												<td>Date Of Birth</td>
												<td class="bg-light">${admin.dob }</td>
											</tr>
											<tr>
												<td>Address</td>
												<td class="bg-light">${admin.doornum }, ${admin.streetname }, ${admin.city }, ${admin.state },${admin.pincode }</td>
											</tr>
										</tbody>
									</table>
								...
								<p>
									<form action = "/admin/editprofilepage" method = "GET">
