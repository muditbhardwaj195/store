				...
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="/admin">Home</a> <span class="mx-2 mb-0">/</span> <a
							href="/admin/admindetails">Admin Details</a> <span class="mx-2 mb-0">/</span> <strong
							class="text-black">${admin2.name}</strong>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="site-section">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6">
						<h2 class="text-black">${admin2.name }</h2>
						...
						<div class="mt-5">
							<ul class="nav nav-pills mb-3 custom-pill" id="pills-tab"
								...
								<li class="nav-item"><a class="nav-link"
									...
									role="tab" aria-controls="pills-profile" aria-selected="false">Admin Details</a>
								</li>
								...
								<div class="tab-pane fade show active" id="pills-profile" role="tabpanel"
									...
									<table class="table custom-table">
										...
										<tbody>
											<tr>
												<td>Name</td>
												<td class="bg-light">${admin2.name }</td>
											</tr>
											<tr>
												<td>Phone</td>
												<td class="bg-light">${admin2.phone }</td>
											</tr>
											<tr>
												<td>Email</td>
												<td class="bg-light">${admin2.email }</td>
											</tr>
											<tr>
												<td>Username</td>
												<td class="bg-light">${admin2.uname }</td>
											</tr>
											<tr>
												<td>Gender</td>
												<td class="bg-light">${admin2.gender }</td>
											</tr>
											<tr>
												<td>Date Of Birth</td>
												<td class="bg-light">${admin2.dob }</td>
											</tr>
											<tr>
												<td>Address</td>
												<td class="bg-light">${admin2.doornum }, ${admin2.streetname }, ${admin2.city }, ${admin2.state },${admin2.pincode }</td>
											</tr>
										</tbody>
									</table>
