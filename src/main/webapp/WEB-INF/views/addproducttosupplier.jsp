				...
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="/admin">Home</a> <span class="mx-2 mb-0">/</span> <a
							href="/admin/supplierdetails">Admin Details</a> <span class="mx-2 mb-0">/</span> <strong
							class="text-black">${supplier.name}</strong>
					</div>
				</div>
			</div>
		</div>
						...
						<div class="mt-5">
							<ul class="nav nav-pills mb-3 custom-pill" id="pills-tab"
								...
								<li class="nav-item"><a class="nav-link"
									...
									role="tab" aria-controls="pills-profile" aria-selected="false">Supplier Details</a>
								</li>
							...
							<div class="tab-content" id="pills-tabContent">
								<div class="tab-pane fade show active" id="pills-profile" role="tabpanel"
									...
									<table class="table custom-table">
										...
										<tbody>
											...
											<tr>
												<td>Email</td>
												<td class="bg-light">${supplier.email }</td>
											</tr>
											<tr>
												<td>Date Of Birth</td>
												<td class="bg-light">$supplier.dob }</td>
											</tr>
											<tr>
												<td>Address</td>
												<td class="bg-light">${supplier.doornum }, ${supplier.streetname }, ${supplier.city }, ${supplier.state },${supplier.pincode }</td>
											</tr>
										</tbody>
									</table>
								...
								<p>
									<form action = "/admin/deleteadmin/${admin2.uname }" method = "POST">
									<input type = "submit" class="buy-now btn btn-sm height-auto px-4 py-3 btn-primary" value = "Delete Admin">
									</form>
								</p>
