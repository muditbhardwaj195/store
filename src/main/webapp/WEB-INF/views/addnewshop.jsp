  ...
  <div class="site-wrap">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0">
            ...
            <strong class="text-black">Add new Shop</strong>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
          	<!-- <h2 class="h3 mb-5 text-black text-center">Step 1</h2> -->
            <h2 class="h3 mb-5 text-black text-center">Enter the details of new Shop:</h2>
            <br>
		<p style="text-align:center; color:${colorOfInstruction} !important;">${msg}</p>
          </div>
          <div class="col-md-12">
    
            <form action="/admin/addnewshop" method="POST">
    
              <div class="p-3 p-lg-5 border">
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="c_email" class="text-black">Shop Description <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="shopdescription" name="shopdescription" required="required">
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-md-6">
                    <label for="c_fname" class="text-black">Doornum <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="doornum" name="doornum" required="required">
                  </div>
                  <div class="col-md-6">
                    <label for="c_lname" class="text-black">Streetname <span class="text-danger">*</span></label>
                ...
                <div class="form-group row">
                  <div class="col-md-6">
                    <label for="c_subject" class="text-black">Pincode <span class="text-danger">*</span></label>
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" pattern="\d{10}" class="form-control" id="phone" name="phone" required="required"/>
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-lg-12">
