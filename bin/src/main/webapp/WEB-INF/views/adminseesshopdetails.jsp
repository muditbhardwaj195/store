				...
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="/admin">Home</a> <span class="mx-2 mb-0">/</span> <strong
							class="text-black">Shop Details</strong>
					</div>
				</div>
			</div>
		</div>
							...
							<table class="table table-bordered">
								<thead>
									<tr>
										...
										<th class="product-quantity">Doornum</th>
										<th class="product-total">Streetname</th>
										<th class="product-remove">City</th>
