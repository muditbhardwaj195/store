			...
			<div class="container">
									...
									<c:forEach items="${cartproductlist }" var="cartproduct">
										<tr>
											<td class="product-thumbnail"><img
												src="/${cartproduct.imagename }" alt="Image" class="img-fluid">
											</td>
											<td class="product-name">
												<h2 class="h5 text-black">${cartproduct.productname }</h2>
											</td>
											<td>${cartproduct.mrp }</td>
											<td>
												<div class="input-group mb-3" style="max-width: 120px;">
													<div class="input-group-prepend">
														<button class="btn btn-outline-primary js-btn-minus"
															type="button" onclick="window.location.href='/customer/cart/subtract/${cartproduct.productid}'">&minus;</button>
													</div>
													<input type="text" class="form-control text-center"
														value=${cartproduct.quantity } placeholder=""
														aria-label="Example text with button addon"
														aria-describedby="button-addon1">
													<div class="input-group-append">
														<button class="btn btn-outline-primary js-btn-plus"
															type="button" onclick="window.location.href='/customer/cart/add/${cartproduct.productid}'" >&plus;</button>
													</div>
												</div>

											</td>
											<td><a href="/customer/cart/removeproduct/${cartproduct.productid }"
				...
				<div class="row">
					<div class="col-md-6">
						<div class="row mb-5">
							<div class="col-md-6">
								<button class="btn btn-outline-primary btn-md btn-block" onclick="window.location.href='/customer'">Continue
									Shopping</button>
							</div>
						</div>
								...
								<div class="row">
									<div class="col-md-12">
										<button class="btn btn-primary btn-lg btn-block"
											onclick="window.location='/customer/enterorderdetails'">Proceed To
											Checkout</button>
									</div>
								</div>
							</div>
