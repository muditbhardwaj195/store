				...
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="/admin">Home</a> <span class="mx-2 mb-0">/</span> <strong
							class="text-black">Suppliers Details</strong>
					</div>
				</div>
			</div>
		</div>
						...
						<table class="table table-bordered">
							<thead>
								<tr>
									...
									<th class="product-remove">Date Of Birth</th>
							...
							<tbody>
								<c:forEach items="${suppliers }" var="supplier">
									<tr>
										<td><a href="/admin/viewsupplierinfo/${supplier.supplierid}">${supplier.supplierid }</a></td>
										<td>${supplier.name }</td>
										<td>${supplier.phone }</td>
										<td>${supplier.email }</td>
										<td>${supplier.doornum }, ${supplier.streetname }, ${supplier.city }, ${supplier.state },${supplier.pincode }</td>
										<td>${supplier.dob }</td>
									</tr>
								</c:forEach>
							</tbody>
