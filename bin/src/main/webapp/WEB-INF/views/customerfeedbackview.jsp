					...
					<div class="col-md-12">
									...
									<table class="table custom-table">
										<tbody>
											...
											<tr>
												...
												<c:if test="${order.assignedemployeestatus != status }">
													<td class="bg-light">${order.assignedemployeeid }
													</td>
												</c:if>
											</tr>
										</tbody>
						...
						<div class="mt-5">
							<ul class="nav nav-pills mb-3 custom-pill" id="pills-tab"
								...
								<li class="nav-item"><a class="nav-link"
									id="pills-profile-tab" data-toggle="pill" href="#pills-profile"
									role="tab" aria-controls="pills-profile" aria-selected="false">Give
										Feedback</a></li>

							</ul>
							<form action="/customer/givefeedback/${order.orderid}"
							method="POST">
								<div class="tab-content" id="pills-tabContent">
									<div class="tab-pane fade show active" id="pills-profile"
										role="tabpanel" aria-labelledby="pills-profile-tab">
										...
										<table class="table custom-table">
											...
											<tbody>
												<tr>
													...
													<td class="bg-light">
														<div class="form-group">
															...
															</label> <select id="websiterating" class="form-control"
																required="required" name="websiterating">
																<option value="" disable selected>Select a
																	rating</option>
												...
												<tr>
													<td>Rate our service:</td>
													<td class="bg-light">
														<div class="form-group">
															<label for="c_country" class="text-black">Select
																rating: <span class="text-danger">*</span>
															</label> <select id="employeerating" class="form-control"
																required="required" name="employeerating">
																<option value="" disable selected>Select a
																	rating</option>
																<option value=1>1</option>
																<option value=2>2</option>
												...
												<tr>
													<td>Give your suggestions:</td>
													<td class="bg-light">
														<div class="form-group">
															<label for="c_order_notes" class="text-black">Order
																Notes</label>
															<textarea name="feedbacktext" id="feedbacktext" cols="30"
																rows="5" class="form-control" required = "required"
