				...
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="/admin">Home</a> <span class="mx-2 mb-0">/</span> <strong
							class="text-black">Feedback Details</strong>
					</div>
				</div>
			</div>
		</div>
						...
						<table class="table table-bordered">
							<thead>
								<tr>
									...
									<th class="product-quantity">Website Rating</th>
									<th class="product-total">Employee Rating</th>
									<th class="product-remove">Suggestion</th>
								</tr>
							</thead>
							<tbody>
								<c:forEach items="${feedbacks}" var="feedback">
									<tr>
										...
										<td><a href="/admin/viewcustinfobyid/${feedback.customerid }">${feedback.customerid }</a></td>
										<td><a href="/admin/vieworderinfo/${feedback.orderid}">${feedback.orderid }</a></td>
										
										<td>${feedback.websiterating }</td>
										<td>${feedback.employeerating }</td>
