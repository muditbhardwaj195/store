	...
	<div class="site-wrap">
		...
		<div class="site-section bg-primary">
			<div class="container">
				<div class="row">
					<div class="col-12">
						<h2 class="text-white mb-4">Shops</h2>
					</div>
					<c:forEach items="${shops}" var="shop">
						<div class="col-lg-4">
							<div class="p-4 bg-white mb-3 rounded">
								<span class="d-block text-black h6 text-uppercase">${shop.streetname }</span>
								<p class="mb-0">${shop.doornum },${shop.streetname },${shop.city },${shop.state },${shop.state }</p>
