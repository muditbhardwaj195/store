	...
	<div class="site-wrap">
		...
		<div class="site-navbar py-2">
			...
			<div class="container">
				<div class="d-flex align-items-center justify-content-between">
						...
						<nav class="site-navigation text-right text-md-center"
							...
							<ul class="site-menu js-clone-nav d-none d-lg-block">
								...
								<li class="has-children"><a href="/admin">${admin.name}</a>
									<ul class="dropdown">
										<li><a href="/admin/seeprofilepage">Manage Your
												Profile</a></li>
					...
					<div class="icons">
						<a href="/admin/orderdetails" class="icons-btn d-inline-block bag">
							<span class="icon-shopping-bag"></span> <span class="number">${unassignedorder }</span>
				...
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="/admin">Home</a> <span class="mx-2 mb-0">/</span> <a
							href="/admin/supplierdetails">Supplier Details</a> <span
							class="mx-2 mb-0">/</span> <strong class="text-black">Supplier
							Details of ID ${supplier.supplierid }</strong>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="site-section">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<h2 class="text-black">${supplier.name }</h2>
						...
						<div class="mt-5">
							<ul class="nav nav-pills mb-3 custom-pill" id="pills-tab"
								...
								<li class="nav-item"><a class="nav-link"
									...
									role="tab" aria-controls="pills-profile" aria-selected="false">Supplier
										Details</a></li>
								...
								<div class="tab-pane fade show active" id="pills-profile"
									...
									<table class="table custom-table">
										<tbody>
											<tr>
												<td>Supplier ID</td>
												<td class="bg-light">${supplier.supplierid }</td>
											</tr>
											<tr>
												<td>Name</td>
												<td class="bg-light">${supplier.name }</td>
											</tr>
											<tr>
												<td>Phone</td>
												<td class="bg-light">${supplier.phone}</td>
											</tr>
											<tr>
												<td>Doornum</td>
												<td class="bg-light">${supplier.doornum }</td>
											</tr>
											<tr>
												<td>Streetname</td>
												<td class="bg-light">${supplier.streetname }</td>
											</tr>
											<tr>
												<td>City</td>
												<td class="bg-light">${supplier.city }</td>
											</tr>
											<tr>
												<td>State</td>
												<td class="bg-light">${supplier.state }</td>
											</tr>
											<tr>
												<td>Pincode</td>
												<td class="bg-light">${supplier.pincode }</td>
											</tr>
										</tbody>
									</table>
									...
									<table class="table custom-table">
										...
										<tbody>
											<tr>
												...
												<td>Click to remove product from supplier list</td>
											</tr>
											<c:forEach items="${productsupplied }" var="product">
												<tr>
													<td>${product.name }</td>
													<td class="bg-light">${product.id }</td>
													<td class=""><a
														href="/admin/removeproductfromsupplier/${supplier.supplierid}/${product.id}">Click
															here.</a></td>
												</tr>
											</c:forEach>
										</tbody>
									...
									<table class="table custom-table">
										...
										<tbody>
											<tr>
												<td>Product Name</td>
												<td class="bg-light">Product ID</td>
												<td>Click to add product in supplier list</td>
											</tr>
											<c:forEach items="${productnotsupplied }" var="product">
												<tr>
													<td>${product.name }</td>
													<td class="bg-light">${product.id }</td>
													<%-- <td>
														<form action="/admin/addproducttosupplier/${supplier.supplierid }" method="POST">
															<input type="submit"
													...
													<td class=""><a
														href="/admin/addproducttosupplier/${supplier.supplierid}/${product.id}">Click
															here.</a></td>
												</tr>
											</c:forEach>
										</tbody>
