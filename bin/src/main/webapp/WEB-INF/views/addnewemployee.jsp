  ...
  <div class="site-wrap">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0">
            ...
            <strong class="text-black">Add new Employee</strong>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="h3 mb-5 text-black text-center">Enter the details of new Employee:</h2>
            <br>
		<p style="text-align:center; color:${colorOfInstruction} !important;">${msg}</p>
          </div>
          <div class="col-md-12">
    
            <form action="/admin/addnewemployee" method="POST">
    
              <div class="p-3 p-lg-5 border">
                <div class="form-group row">
                  <div class="col-md-6">
                    <label for="c_fname" class="text-black">Employee Name <span class="text-danger">*</span></label>
                ...
                <div class="form-group row">
                  <div class="col-md-6">
                    <label for="c_fname" class="text-black">Gender <span class="text-danger">*</span></label>
                ...
                <div class="form-group row">
                  <div class="col-md-6">
                    <label for="c_fname" class="text-black">Enter Shop ID <span class="text-danger">*</span></label>
                    <input type="number" class="form-control" id="shopid" name="shopid">
                  </div>
                  <div class="col-md-6">
                    <label for="c_lname" class="text-black">Joining Date <span class="text-danger">*</span></label>
                    <input type="date" class="form-control" id="hiringdate" name="hiringdate">
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="c_subject" class="text-black">Salary </label>
