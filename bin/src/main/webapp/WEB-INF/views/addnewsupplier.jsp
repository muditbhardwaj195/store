      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0">
            ...
            <strong class="text-black">Add new Supplier</strong>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            ...
            <h2 class="h3 mb-5 text-black text-center">Enter the details of new Supplier:</h2>
            <br>
		<p style="text-align:center; color:${colorOfInstruction} !important;">${msg}</p>
          </div>
          <div class="col-md-12">
    
            <form action="/admin/addnewsupplier" method="POST">
    
              <div class="p-3 p-lg-5 border">
                <div class="form-group row">
                  <div class="col-md-6">
                    <label for="c_fname" class="text-black">Supplier Name <span class="text-danger">*</span></label>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <label for="c_lname" class="text-black">Date Of Birth <span class="text-danger">*</span></label>
