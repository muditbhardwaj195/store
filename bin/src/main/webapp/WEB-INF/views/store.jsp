				...
				<div class="row">
					<div class="col-lg-4">
						<div class="form-group">
									<label for="c_country" class="text-black">Filter by: <span class="text-danger">*</span>
									</label> <select id="filtervalue" class="form-control"
										 name = "filtervalue">
										
										<option value = 2 selected>Name, A to Z</option>
										<option value = 3 selected>Name, Z to A</option>
										<option value = 4 selected>Price, low to high</option>
										<option value = 5 selected>Price, high to low</option>
				...
				<div class="row">
					...
					<c:forEach items="${products}" var="product">
						<div class="col-sm-6 col-lg-4 text-center item mb-4">
							<span class="tag">Sale</span> <a href="/customer/store/${product.id }"> <img
								src=${product.imname } alt="Image"></a>
							<h3 class="text-dark">
								<a href="/customer/store/${product.id}">${product.name }</a>
							</h3>
							<c:set var = "total" value = "${100 + product.mrp }]" />
							<p class="price">
								<del>${total}</del>
								&mdash; ${product.mrp }
							</p>
